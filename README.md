...
```go
import "github.com/joint-online-judge/go-gitignore"
...
For more information see `godoc github.com/joint-online-judge/go-gitignore`.
...
```go
go get github.com/joint-online-judge/go-gitignore
```
